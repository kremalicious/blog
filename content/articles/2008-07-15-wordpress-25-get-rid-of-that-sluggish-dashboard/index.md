...
![Wordpress Logo by kremalicious](./wordpress-logo.png)
...
Now just uncomment the lines so it looks like this (every line with leading `//` is commented and therefore inactive):
