...
module Jekyll
  ...
  class Picture < Liquid::Tag
    ...
    def render(context)
      ...
      instance.each { |key, source|
        instance[key][:generated_src] = generate_image(source, site.source, site.dest, settings['source'], settings['output'], site.config['cdnurl'], site.config["baseurl"])
      }
    ...
    def generate_image(instance, site_source, site_dest, image_source, image_dest, cdnurl, baseurl)
